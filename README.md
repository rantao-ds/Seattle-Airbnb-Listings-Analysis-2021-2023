...
The **Short-Term** dataset focused on Seattle's short-term rental regulation, which requires operators running short-term rentals to obtain a license valid for up to two units. Of those two units, one must be the operator's primary residence. In other words, Seattle enforces strict regulations on the short-term rental market, allowing only up to two units under one license to prevent commercialization. To capture this, I created a variable "compliance" to flag licenses associated with more than two units as "violation", those with two or fewer listings as "legal", and listings with no license as "no_license". 

The **Long-Term** dataset also looked at operators but from a different perspective. Seattle does not set any specific requirements for long-term rental operation licenses, and the market is largely commercialized as there are many professional management companies running vacation and corporate housing. So, I created a variable "host_type" to mark units run by professional companies as "corporate" and other units as "residential".


## Exploratory Data Analysis (EDA)
The primary goal of the EDA is to understand how operators across different stay types affect the median rental price of the Seattle Airbnb rental market. The first part takes a glance at the overall composition of the Seattle Airbnb market. The second and third parts specifically analyze the long-term and short-term markets, focusing on entire home/apartment listings only. The fourth part of the EDA explores whether longer stays are associated with lower prices by comparing monthly rates across short-term and long-term entire home/apartment stays.

### At a Glance

With 78.9% of stay types being "short-term" and 87.2% of room types being "Entire Home/Apt", these plots clearly indicate that entire home/apt short-term rentals absolutely dominate the Seattle Airbnb market. In particular, the "Entire Home/Apt" room type accounts for the majority of both long-term and short-term rentals, at 86.2% and 87.5%, respectively. This suggests that Airbnb users in Seattle are likely to take short trips with a strong preference for large and private accommodations, which reinforces the previously mentioned idea that Seattle's visitors are likely traveling for business or family tourism purposes.
...
In terms of nightly pricing, violation listings have a slightly lower median rate than legal listings ($134 vs. $141), but a noticeably higher mean rate ($192 vs. $170). This larger gap between the mean and median (+$58.2 vs. +$29.1) reflects much stronger right-skewness among violation listings.

As shown in the boxplot, both groups have very similar central distributions, with comparable medians, interquartile ranges (IQRs), and upper whiskers. The main difference appears in the upper tail. While legal listings show a dense cluster of typical premium outliers, violation listings display more extreme and unevenly spaced high-price outliers. Overall, both groups price their typical units similarly, but violation listings include a subset of exceptionally high-priced properties that pull their average rate upward.
...
Comparing pricing across the top five short-term entire home/apartment neighbourhoods, median nightly rates in ***Other Neighbourhoods***, ***West Seattle***, ***Capitol Hill***, and ***Central Area*** are closely clustered between $129 and $136. ***Downtown*** commands the highest median rate at $157 along with the least right-skewness (+$19). By contrast, ***Other Neighbourhoods*** has the lowest median rate at $129 but the strongest right-skewness (+$40), followed by ***West Seattle*** (+$32), ***Capitol Hill*** (+$31), and ***Central Area*** (+$22).


Overall, the boxplots show that all five neighbourhoods share similar central pricing structures, IQRs, and whisker lengths. While ***Downtown*** sits at a slightly higher price point, the main differences lie in the outlier tails. ***Central Area*** and ***West Seattle*** have relatively contained spreads, with all outliers staying below $400 per night. ***Downtown*** and ***Capitol Hill*** share similar patterns, each showing a single extreme outlier above $500 per night with sparse points below that mark. Meanwhile, ***Other Neighbourhoods*** shows the densest cluster of premium outliers, with several properties extending well beyond $500 per night.
...
In terms of monthly pricing, corporate listings managed by professional companies have higher average and median rates than residential listings. However, residential listings show greater right-skewness (+$852 vs. +$630), pointing to a wider price spread with more extreme outliers.

The boxplot clearly reflects this pattern. While both groups share very similar box sizes (IQRs), corporate listings sit at a slightly higher median rate. The real difference is in the upper tail. While corporate listings occasionally reach above $7,500 per month, they rarely cross $10,000. In contrast, residential listings show a much denser cluster of extreme outliers, with multiple luxury properties extending past both $7,500 and $10,000 per month.
...
Compared to the short-term market, where boxplots are fairly uniform across neighbourhoods, long-term boxplots show much greater variation in their spreads, whisker lengths, and outlier patterns. First, ***Capitol Hill***, ***Downtown***, and the ***University District*** show relatively few extreme outliers despite differences in their medians and IQRs, pointing to more stable pricing structures. Second, while ***Central Area*** appeared stable in the short-term market, it displays an unusual pattern in the long-term market: it not only has the highest median monthly rate and the widest IQR, but its upper whisker extends all the way to the $10,000 chart limit. Finally, while ***Other Neighbourhoods*** showed a dense cluster of premium outliers in the short-term market, its long-term market displays only a modest cluster of outliers below $10,000 per month.
...
**3. Robust Standard Errors (Robust SE)**
